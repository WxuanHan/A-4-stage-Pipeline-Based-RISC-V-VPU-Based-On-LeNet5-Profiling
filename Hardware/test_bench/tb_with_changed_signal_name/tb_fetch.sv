...
module tb_vpu_fetch();
    ...
    vpu_fetch #(.BW_VL(BW_VL)) uut (
        ...
        .cs_data_o(cs_data_o),
        .ls_addr_o(ls_addr_o),
        .if_rvalid_o(if_rvalid_o),
        .if_rcs_data_o(if_rcs_data_o),
        .wb_req_o(wb_req_o)
    );
    ...
    initial begin
        ...
        inv_insn_i = 1;
        wb_gnt_i = 1;  // Grant request
        #10;
        if_req_i = 0;  // Remove request
        wb_gnt_i = 0;  // Remove grant
        #50;
        ...
        repeat (5) begin
            ...
            wb_gnt_i = 1;  // Always grant to check throughput
            #10;
            if_req_i = 0;
        end
        ...
        if_req_i = 1;
        wb_gnt_i = 0;  // No grant, should test stalling
        #30;
        wb_gnt_i = 1;  // Now grant
        #10;
        if_req_i = 0;
        wb_gnt_i = 0;
        #20;
